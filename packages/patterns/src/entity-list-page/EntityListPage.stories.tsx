      ...
      <EntityListPage
        header={
          <PageHeader
            ...
            actions={
              <Button leadingIcon={<Plus size={16} />}>Nouveau dossier</Button>
            }
          ...
          <StatsGrid
            ...
            items={[
              ...
              },
              {
                ...
                label: 'À corriger',
                value: '7',
                description: 'Retour attendu du postulant',
                trend: 'Prioritaire',
                tone: 'warning',
                icon: <TimerReset />,
              },
          ...
          <FilterBar
            search={
              <Input
                ...
                placeholder="Rechercher un dossier ou un postulant…"
        ...
        table={
          <DataTable
            table={table}
            emptyState="Aucun dossier ne correspond aux critères."
        ...
        pagination={
          <>
            ...
            <div
              style={{ display: 'flex', gap: 'var(--layout-gap-sm, 0.5rem)' }}
            >
...
export const WithoutStats: Story = {
  args: {
    header: (
      <PageHeader
        title="Liste simplifiée"
        description="Composition sans indicateurs."
      />
    ),
    filters: (
      <FilterBar
