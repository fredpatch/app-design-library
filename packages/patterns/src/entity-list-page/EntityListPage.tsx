...
export function EntityListPage({
  ...
  return (
    <main className="fp-entity-list-page">
      ...
      {notices ? (
        <section
          className="fp-entity-list-page__notices"
      ...
      {stats ? (
        <section
          className="fp-entity-list-page__stats"
      ...
      {filters ? (
        <section
          className="fp-entity-list-page__filters"
      ...
      <section className="fp-entity-list-page__results" aria-label="Résultats">
        ...
        {pagination ? (
          <footer className="fp-entity-list-page__pagination">
            {pagination}
          </footer>
        ) : null}
      </section>
