...
export const WithError: Story = {
  args: {
    ...
    children: <Input placeholder="+241 00 00 00 00" />,
  },
};
...
export const TextareaField: Story = {
  args: {
    label: 'Observations',
    description:
      'Ajoutez uniquement les informations utiles au traitement du dossier.',
    ...
    <div style={{ display: 'grid', gap: 20, width: 440 }}>
      {(['comfortable', 'compact', 'dense'] as const).map((density) => (
        <div key={density} data-density={density}>
          <FormField
            label={`Adresse e-mail — ${density}`}
            description="Champ de comparaison de densité."
          >
