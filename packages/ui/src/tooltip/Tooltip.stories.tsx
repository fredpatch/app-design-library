...
export const LongFrenchContent: Story = {
  args: {
    content:
      'Cette action permet de consulter les informations complémentaires associées au dossier sélectionné.',
    children: <Button variant="outline">Afficher l’aide</Button>,
  },
};
  ...
  render: () => (
    <div style={{ display: 'flex', gap: 24 }}>
      {['neutral', 'prestix', 'anac-institutional'].map((theme) => (
        ...
        >
          <Tooltip content={`Infobulle ${theme}`}>
